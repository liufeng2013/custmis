...
l&&l.call(a);if(!h){a.setData(e.val());if(c.focus)a.focus();else(g=a.getSelection())&&g.removeAllRanges();h=p}},{global:d})});return a};a.use=a.use;a.Config.base=d.Config.base;a.Config.debug=d.Config.debug;a.Config.componentJsName=j;a.init(e);return a}var n=b.DOM,p=true,o=false,j;j=parseFloat(b.version)<1.2?function(){return"plugin-min.js?t=2011-05-17 11:58:27"}:function(e,c){return e+"/plugin-min.js"+(c?c:"?t=2011-05-17 11:58:27")};b.app(d,b.EventTarget);d.Config.base=b.Config.base+"editor/plugins/";d.Config.debug=
