...
k&&k.call(a);if(!h){a.setData(e.val());if(d.focus)a.focus();else(g=a.getSelection())&&g.removeAllRanges();h=p}},{global:c})});return a};a.use=a.use;a.Config.base=c.Config.base;a.Config.debug=c.Config.debug;a.Config.componentJsName=m;a.init(e);return a}function m(){return"plugin-min.js?t=2011-01-12 23:00:39"}var n=b.DOM,p=true,o=false;b.app(c,b.EventTarget);c.Config.base=b.Config.base+"editor/plugins/";c.Config.debug=b.Config.debug;c.Config.componentJsName=m;b.Editor=c;b.Editor=c});
